...
{
    if (!_loadingArray) {
        _loadingArray=[[NSMutableArray array] init];
    }
...
//            
//            for (int i=0; i<3; i++) {
//                [self.loadingArray addObject:[UIImage imageNamed:[NSString stringWithFormat:@"dropdown_loading_0%d",i + 1]]];
//            }
//            
//            //设置动画数组
...
////            [(UIImageView *)self.indicator setAnimationDuration:5];
//
//            //开始动画
